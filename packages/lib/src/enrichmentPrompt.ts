export const ENRICHMENT_PROMPT = `You are given a Markdown file that may contain multiple languages. Your task is to enrich this file by identifying metadata and languages.
    ...
    4. Preserve all incoming comments. The input markdown may already have \`<!-- page-break -->\` comments.
    ...
    conversionHistory: ["enriched by <name of the current LLM model>"]
    ---
